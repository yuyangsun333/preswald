...
threshold = slider("Filter by Data Value", min_val=df["Data Value"].min(), max_val=df["Data Value"].max(), default=10)
...
fig = px.scatter(filtered_dynamic_df, 
                 x="Time Period", y="Data Value", 
                 color="Name", size="Data Value", 
...
fig2 = px.bar(filtered_dynamic_df, 
