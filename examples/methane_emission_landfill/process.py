...
def process_data():
    ...
    emissions_df = pd.read_csv(os.path.join(base_dir, 'data', 'facility_data.csv'))  # Sheet 1: Emission Data
    point_source_df = pd.read_csv(os.path.join(base_dir, 'data', 'source_attributions.csv'))  # Sheet 2: Point Source Data
    plume_df = pd.read_csv(os.path.join(base_dir, 'data', 'plume_detections.csv'))  # Sheet 3: Plume Data
