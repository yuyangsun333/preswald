...
text("Exploring trends in compensation, overtime pay and employee benefits over the years")
...
fig1 = px.line(grouped_df, x='Year', y='TotalPayBenefits',
...
fig2 = px.histogram(df, x='BasePay', nbins=50, title='Distribution of Base Pay',
                    range_x=[0, df['BasePay'].max()])
fig3 = px.histogram(df, x='OvertimePay', nbins=50, title='Distribution of Overtime Pay',
                    range_x=[0, df['OvertimePay'].max()])
fig4 = px.histogram(df, x='Benefits', nbins=50, title='Distribution of Benefits',
...
fig6 = px.scatter(df, x='TotalPayBenefits', y='BenefitsProportion', 
