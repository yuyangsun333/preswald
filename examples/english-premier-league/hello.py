...
fig = px.scatter(
    ...
    labels={
        'H Shots': 'Home Team Shots',
        'FTH Goals': 'Home Team Goals'
    },
    color='League',
...
home_points = premier_league_df.groupby('HomeTeam').apply(calculate_points).reset_index()
...
league_table = league_table[['Rank', 'Team', 'Total_Points', 'Home_Points', 'Away_Points']]
table(league_table)
