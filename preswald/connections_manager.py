...
class ConnectionsManager:
    ...
    def _parse_connection(self, key: str, value: Dict) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error parsing connection {key}: {str(e)}")
            raise
    
    def _is_postgres_connection(self, value: Dict) -> bool:
        """Check if the connection is PostgreSQL type."""
        return all(field in value for field in ["host", "port", "dbname"]) and value.get("port") == 5432
    ...
    def _parse_postgres_connection(self, key: str, value: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            if not password:
                ...
                return self._create_connection_dict(key, "PostgreSQL", details, "configured", metadata)
    ...
    def _get_postgres_metadata(self, details: Dict[str, str], password: str) -> Dict[str, Any]:
    ...
    def _create_csv_metadata(self, df: pd.DataFrame, total_rows: int, 
                           file_size_mb: float, source: str) -> Dict[str, Any]:
    ...
    @staticmethod
    def _create_connection_dict(name: str, conn_type: str, details: Dict[str, Any],
                              status: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
