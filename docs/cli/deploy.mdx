...
- **`api-key` (str):**  
  Structured API Key. See preswald.com and sign in for account and org details.
...
- **Structured Cloud Deployment:**  
  Get an API key from Settings at https://preswald.com. The CLI will provide guidance on setup.
