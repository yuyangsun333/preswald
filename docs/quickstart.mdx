...
You will be prompted to pass in your GitHub username and Preswald API key. Get the preswald API key from our [cloud console](https://preswald.com/) and dashboard. Click on Organization name > Manage > API Keys.   
